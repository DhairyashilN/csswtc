...
<head>
	...
	<title>Chintamani Services | Other Customers</title>
		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Other (Non Sujal) Customers</li>
				</ol>
			</section>
			...
			<section class="content">
				...
				<div class="box">
					<div class="box-header with-border">
						<span class="box-title">Customers <a href="<?php echo site_url('add_non_sujal_customer'); ?>"><button class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add New</button></a></span>
					</div>
					<div class="box-body">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('edit_non_sujal_customer/'.$row['id']); ?>" title="Edit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
						                        ...
						                        <div class="modal-dialog" role="document">
						                        	<div class="modal-content">
						                            	<div class="modal-body text-center">
						                              		...
						                              		<a href="<?php echo site_url('delete_non_sujal_customer/'.$row['id']);?>"><button type="button" class="btn btn-danger" >Yes</button></a>&nbsp;&nbsp;
						                        ...
						                        <div class="modal-dialog" role="document">
						                        	<div class="modal-content">
						                            	...
						                            	<div class="modal-body ">
						                              		<ul class="list-group">
																<li class="list-group-item"><b>Customer ID :</b> <?php echo $row['cust_unique_id'] ?></li>
