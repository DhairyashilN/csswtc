...
<head>
	...
	<title>Chintamani Services | Water Tank Types</title>
		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Water Tank Types</li>
				</ol>
			</section>
			...
			<section class="content">
				...
				<div class="box">
					<div class="box-header with-border">
						<span class="box-title"><a href="<?php echo site_url('add_water_tank_type'); ?>"><button class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add New</button></a></span>
					</div>
					<div class="box-body">
						...
						<div class="table-responsive">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<?php 
										$count = 1;
										if (isset($ArrTankTypes) && !empty($ArrTankTypes)) {
										foreach ($ArrTankTypes as $row) {
									?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('edit_water_tank_types/'.$row['id']); ?>" title="Edit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
