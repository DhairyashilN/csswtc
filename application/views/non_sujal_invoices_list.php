		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Other (Non Sujal) Invoices</li>
				</ol>
			</section>
			...
			<section class="content">
				...
				<div class="box">
					<div class="box-header with-border">
						<span class="box-title">Invoices <a href="<?php echo site_url('create_non_sujal_invoice'); ?>"><button class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Create New</button></a></span>
					</div>
					<div class="box-body">
							...
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="<?php echo site_url('view_non_sujal_invoice/'.$row['id']); ?>" title="View" target="_blank"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
											...
											<a href="<?php echo site_url('edit_non_sujal_invoice/'.$row['id']); ?>" title="Edit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
						                        ...
						                        <div class="modal-dialog" role="document">
						                        	<div class="modal-content">
						                            	<div class="modal-body text-center">
						                              		...
						                              		<a href="<?php //echo site_url('delete_sujal_pro/'.$row['id']);?>"><button type="button" class="btn btn-danger" >Yes</button></a>&nbsp;&nbsp;
