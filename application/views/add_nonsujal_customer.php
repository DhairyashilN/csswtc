...
<head>
	...
	<title>Chintamani Services | Add Non Sujal Customer</title>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					Sujal 
					<small>Add Other (Non Sujal) Customer</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">Add Other (Non Sujal) Customer</li>
				</ol>
			</section>
			...
			<section class="content">
				<div class="box">
					<div class="box-header with-border">
						<span class="box-title"><a href="<?php echo site_url('non_sujal_customers'); ?>"><button class="btn btn-warning"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back to List</button></a></span>
					</div>
					<div class="box-body">
						<?php if (isset($ObjCustomer->id) && !empty($ObjCustomer->id)): ?>
							<?php echo form_open('save_non_sujal_customer/'.$ObjCustomer->id, array('method'=>'post','class'=>'form-horizontal','autocomplete'=>'off')); ?>
						<?php else: ?>
							<?php echo form_open('save_non_sujal_customer', array('method'=>'post','class'=>'form-horizontal','autocomplete'=>'off')); ?>
						<?php endif ?>
