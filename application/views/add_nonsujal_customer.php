				...
				<div class="box">
					...
					<div class="box-body">
						<?php if (isset($ObjCustomer->id) && !empty($ObjCustomer->id)): ?>
							<?php echo form_open('save_non_sujal_customer/'.$ObjCustomer->id, array('method'=>'post','class'=>'form-horizontal')); ?>
						<?php else: ?>
							<?php echo form_open('save_non_sujal_customer', array('method'=>'post','class'=>'form-horizontal')); ?>
						<?php endif ?>
