				...
				<div class="box">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="sale_date" name="sale_date" placeholder="Sale Date" required="" value="<?php echo (isset($ObjOrder->order_date) && !empty($ObjOrder->order_date) ? $ObjOrder->order_date : '' ); ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="inputCustomers" class="col-sm-2 control-label">Select Customer</label>
							<div class="col-sm-10">
								<input type="hidden" name="customer" id="customer" value="<?php echo (isset($ObjOrder->sujal_cust_id) && !empty($ObjOrder->sujal_cust_id) ? $ObjOrder->sujal_cust_id : '' ); ?>" >
								<input type="text" class="form-control" name="customer_name" id="customer_name" value="<?php echo (isset($ObjOrder->customer_name) && !empty($ObjOrder->customer_name) ? $ObjOrder->customer_name : '' ); ?>">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<div class="form-group">
									...
									<div class="col-lg-2">
										<input type="text" name="order_total" id="order_total" class="form-control" required="" value="<?php echo (isset($ObjOrder->order_amount) && !empty($ObjOrder->order_amount) ? $ObjOrder->order_amount : '' ); ?>">
									</div>
								</div>
								<div class="pull-right">
									<input type="checkbox" name="add_tax" id="add_tax" onchange="valueChanged()" <?php if($ObjOrder->order_tax_amount != 0.00){ echo 'checked'; } ?>> Add Tax
								</div><br>
								<div id="tax_div" style="<?php if($ObjOrder->order_tax_amount !=0.00){ echo 'display: block'; }else{ echo 'display: none'; } ?>">
									<div class="form-group">
										<label class="control-label col-lg-offset-8 col-lg-2">Tax Rate</label>
										<div class="col-lg-2">
											<input type="text" name="tax_rate" id="tax_rate" class="form-control" value="<?php echo (isset($ObjOrder->order_tax_rate) && !empty($ObjOrder->order_tax_rate) ? $ObjOrder->order_tax_rate : '' ); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-offset-8 col-lg-2">CGST</label>
										<div class="col-lg-2">
											<input type="text" name="cgst" id="cgst" class="form-control" value="<?php echo (isset($ObjOrder->order_tax_amount) && !empty($ObjOrder->order_tax_amount) ? ($ObjOrder->order_tax_amount/2) : '' ); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-offset-8 col-lg-2">SGST</label>
										<div class="col-lg-2">
											<input type="text" name="sgst" id="sgst" class="taxnos form-control" value="<?php echo (isset($ObjOrder->order_tax_amount) && !empty($ObjOrder->order_tax_amount) ? ($ObjOrder->order_tax_amount/2) : '' ); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-offset-8 col-lg-2">Tax Amount</label>
										<div class="col-lg-2">
											<input type="text" name="order_tax" id="order_tax" class=" taxnos form-control" value="<?php echo (isset($ObjOrder->order_tax_amount) && !empty($ObjOrder->order_tax_amount) ? $ObjOrder->order_tax_amount : '' ); ?>">
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-lg-2">
										<input type="text" name="order_net_amount" id="order_net_amount" class="form-control" required="" value="<?php echo (isset($ObjOrder->order_net_amount) && !empty($ObjOrder->order_net_amount) ? $ObjOrder->order_net_amount : '' ); ?>">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-lg-offset-8 col-lg-2">Paid Amount</label>
									<div class="col-lg-2">
										<input type="text" name="order_paid_amount" id="order_paid_amount" class="form-control" required="" value="<?php echo (isset($ObjOrder->order_paid_amount) && !empty($ObjOrder->order_paid_amount) ? $ObjOrder->order_paid_amount : '' ); ?>">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-lg-offset-8 col-lg-2">Due Amount</label>
									<div class="col-lg-2">
										<input type="text" name="order_due_amount" id="order_due_amount" class="form-control" required="" value="<?php echo (isset($ObjOrder->order_due_amount) && !empty($ObjOrder->order_due_amount) ? $ObjOrder->order_due_amount : '' ); ?>">
									</div>
								</div>
							</div>
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					$('.btn-add-row').on('click', function(){
						...
						i++;
						$('#icnt').val($('#order_items_table tr').length-1);
						calculateTotal();
						$('#sproduct_name').val('');
						$('#sproduct_price').val('');
