...
<head>
	...
	<title>Chintamani Services | Sujal Products</title>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					Sujal 
					<small>RO Water Purifier Products</small>
				</h1>
				<ol class="breadcrumb">
			...
			<section class="content">
				...
				<div class="box">
					<div class="box-header with-border">
						<span class="box-title">Products <a href="<?php echo site_url('add_sujal_product'); ?>"><button class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add New</button></a></span>
					</div>
					<div class="box-body">
